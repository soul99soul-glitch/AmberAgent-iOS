...
final class IOSNovelCreationWiringTests: XCTestCase {
    ...
    func testContinuityAuditEntryIsReachableFromTheLiveCompendiumView() throws {
        ...
        XCTAssertTrue(auditView.contains("viewModel.startContinuityRepair()"))
        XCTAssertTrue(auditView.contains("viewModel.startContinuityRepair(issueIDs:"))
        XCTAssertTrue(auditView.contains("一键修复"))
        XCTAssertTrue(auditView.contains("presenting: pendingRepair"))
        XCTAssertTrue(auditView.contains("NovelContinuityRepairPlanner.targetReference"))
        XCTAssertTrue(auditView.contains(".buttonStyle(.bordered)"))
        ...
        XCTAssertTrue(viewModel.contains("try await creation.repairContinuity("))
